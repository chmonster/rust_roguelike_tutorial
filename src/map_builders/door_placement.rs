...
impl DoorPlacement {
    ...
    fn door_possible(&self, build_data: &mut BuilderMap, idx: usize) -> bool {
        ...
        if build_data.map.tiles[idx] == TileType::Floor
            ...
            && (x < build_data.width - 2 && build_data.map.tiles[idx + 1] == TileType::Floor)
            && (y > 1 && build_data.map.tiles[idx - build_data.width as usize] == TileType::Wall)
            && (y < build_data.height - 2
                && build_data.map.tiles[idx + build_data.width as usize] == TileType::Wall)
        {
            return true;
        }
        ...
        if build_data.map.tiles[idx] == TileType::Floor
            ...
            && (x < build_data.width - 2 && build_data.map.tiles[idx + 1] == TileType::Wall)
            && (y > 1 && build_data.map.tiles[idx - build_data.width as usize] == TileType::Floor)
            && (y < build_data.height - 2
                && build_data.map.tiles[idx + build_data.width as usize] == TileType::Floor)
        {
            return true;
        }
