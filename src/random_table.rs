use crate::data::{spawn_type_by_name, DataMaster, SpawnTableType};
...
impl MasterTable {
    ...
    pub fn add<S: ToString>(&mut self, name: S, weight: i32, data: &DataMaster) {
        match spawn_type_by_name(data, &name.to_string()) {
